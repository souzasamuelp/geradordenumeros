...
<h1 align="center">
    <img alt="Readme" title="Readme" src="./github/randomnumber.gif">
</h1>

<h2>Sobre o Projeto</h2>

<p>Esta aplicação gera um número aleatório entre 1 a 100 e para executar necessita clicar em "Clique em mim". Ao clicar em "Limpar", todos os resultados serão limpos.</p> 
